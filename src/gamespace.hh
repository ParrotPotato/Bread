...
#define MAX_COLLIDER_COUNT   128

struct Player {
    unsigned int box_collider_idx;
};
...
struct GameMemory{
    ...
    MemoryStackAllocator temporary;
    ...
    // boxcollider instancing

    Player  player;

    BoxCollider colliders[MAX_COLLIDER_COUNT];
